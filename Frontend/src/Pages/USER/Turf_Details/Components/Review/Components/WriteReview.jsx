...
const WriteReview = () => {
    ...
    const submitReview = async () => {
        const response = await reviewSubmit(token, { rating, text })
    }
    return (
        <div className="flex pt-16 pb-10 flex-col max-w-xl px-8 shadow-sm rounded-xl lg:px-12 bg-gray-900 text-gray-100">
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-col items-center py-6 space-y-3">
                    ...
                    <div className="flex space-x-3">
                        ...
                        {Array(5).fill('').map((e, index) => (
                            <button type="button" onClick={() => setRating(index)} title="Rate 5 stars" aria-label="Rate 5 stars">
                ...
                <div className="flex flex-col w-full">
                    <textarea onChange={() => setText(e.target.value)} value={text} rows="3" placeholder="Message..." className="p-4 rounded-md resize-none text-gray-100 bg-gray-900"></textarea>
