...
const BarGraph = ({ data }) => (
    <div className="p-10 w-full">
        <h3 className="text-violet-100 text-3xl font-bold text-center my-5 pl-20">Turf Wise Earnings</h3>
        <ResponsiveContainer width="100%" height={400}>
            <BarChart data={data} margin={{ top: 20, right: 20, left: 20, bottom: 20 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#555" />
                <XAxis dataKey="name" label={{ value: 'Total Cost'}} tick={{ fontSize: 14, fill: "#ccc" }} tickMargin={10} stroke="#ccc" />
