...
import { FormValidate } from "../../Helpers/ValidateForm.js";
import { success } from "../Suepr_Admin/Layout/Swal.js";

const TurfPorfile = () => {
    const [details, setDetails] = useState({})
    const [editData, setEditData] = useState({ courtName: '', loction_Details: '', Holiday: '', Price: '', enquiryNumber: '', openingTime: '', closingTime: '',request:'Successfull' })
