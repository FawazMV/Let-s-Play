...
import { getPaymentDetails } from '../../../API/ServerRequests/Turf/TurfsApi'
const Turf_Dashboard = () => {
    ...
    return (
        <div className='pt-20 bg-slate-800 min-h-screen text-gray-300'>Turf_Dashboard
            <div className='flex justify-evenly'>
                <div className="flex flex-col bg-gray-900 p-2 rounded-xl">
                    ...
                    <div className="flex flex-col flex-1 p-2">
                        ...
                        <button className='p-2 bg-green-600 font-semibold text-sm tracking-wider uppercase  hover:bg-green-500 transition rounded-2xl'>Withdraw</button>
                    </div>
                </div>
            </div>
        </div>
