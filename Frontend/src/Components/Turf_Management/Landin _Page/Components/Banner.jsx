        ...
        <div className='flex w-full h-full justify-evenly items-center'>
            <div>
                ...
                <div className='w-full flex xs:pl-0 justify-evenly mt-3'>
                    <button className="text-black bg-white mb-2 border-[1px]   border-inherit font-[Poppins] py-2 px-6 rounded-xl  hover:bg-transparent hover:text-white duration-500"> Registration</button>
                </div>
            </div>
        </div>
